...
@section('content')
 <link rel="stylesheet" href="{{URL::to('/')}}/assets/examples/css/pages/invoice.css">
      ...
      <div class="panel">
        <div class="panel-body container-fluid">
          <div class="row">
            <div class="col-md-3">
              <h4>			  
                <img width="36" class="margin-right-10" src="{{URL::to('/')}}/uploads/1477189043.png" alt="...">ELEGANT</h4>
              <address>
