...
@section('content')
<link rel="stylesheet" href="{{URL::to('/')}}/assets/examples/css/structure/ribbon.css">
<div class="page-header">
  <h1 class="page-title font_lato">Ribbon </h1>
  <div class="page-header-actions">
	<ol class="breadcrumb">
		<li><a href="{{URL::to('/dashboard')}}">{{ trans('app.home')}}</a></li>
		<li class="active">Ribbon</li>
	</ol>
  </div>
</div> 
        ...
        <div class="panel-body container-fluid">
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="example-wrap">
                ...
                <p>Ribbons have shared markup, starting with the default <code>.ribbons</code>                  class, as well as shared states. Swap modifier classes <code>.vertical</code>                  to switch ribbon direction. Add any of the below mentioned modifier
          ...
          <div class="row">
            <div class="col-sm-12">
              <!-- Example Reverse -->
              <div class="example-wrap">
                <h4 class="example-title">Reverse</h4>
                <p> Alternatively, you can align ribbons to the right by using <code>.ribbon-reverse</code>                  utility classes.</p>
                <div class="row">
                  <div class="col-lg-2 col-sm-4">
          ...
          <div class="row">
            <div class="col-sm-12">
              <!-- Example Bookmark -->
              <div class="example-wrap">
                <h4 class="example-title">Bookmark</h4>
          ...
          <div class="row">
            <div class="col-sm-12">
              <!-- Example Clip -->
              <div class="example-wrap">
                <h4 class="example-title">Clip</h4>
          ...
          <div class="row">
            <div class="col-sm-6">
              ...
              <div class="example-wrap margin-sm-0">
                <h4 class="example-title">Badge</h4>
            ...
            <div class="col-sm-6">
              <!-- Example Corner -->
              <div class="example-wrap">
                <h4 class="example-title">Corner</h4>
