...
@section('content')
<link rel="stylesheet" href="{{URL::to('/')}}/assets/examples/css/uikit/icons.css">
  <link rel="stylesheet" href="{{URL::to('/')}}/global/fonts/7-stroke/7-stroke.css">
  <link rel="stylesheet" href="{{URL::to('/')}}/global/fonts/ionicons/ionicons.css">
  <link rel="stylesheet" href="{{URL::to('/')}}/global/fonts/material-design/material-design.css">
  <link rel="stylesheet" href="{{URL::to('/')}}/global/fonts/mfglabs/mfglabs.css">
  <link rel="stylesheet" href="{{URL::to('/')}}/global/fonts/open-iconic/open-iconic.css">
  <link rel="stylesheet" href="{{URL::to('/')}}/global/fonts/themify/themify.css">
  <link rel="stylesheet" href="{{URL::to('/')}}/global/fonts/weather-icons/weather-icons.css">
  <link rel="stylesheet" href="{{URL::to('/')}}/global/fonts/glyphicons/glyphicons.css">
...
<div class="page-content">
      <div class="padding-vertical-15">
        <div class="text-center">
          <h3>Browse 12 icons sets.</h3>
          <p class="title-desc">Web icons / Font awesome / 7-Stroke / Brand Icons / Glyphicons / Ion
            Icons / Material Design / Mfglabs / Open Iconic / Themify / Weather
            icons / Octicons</p>
        </div>
      </div>
      <!-- Panel -->
            ...
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="{{URL::to('/ElementsController/webIcons')}}">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="{{URL::to('/ElementsController/fontAwesome')}}">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="{{URL::to('/ElementsController/strokeIcon')}}">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              <h4 class="example-title">brand-icons</h4>
              <div class="example example-well overlay overlay-hover">
                <ul class="blocks-xs-6 margin-0">
                  <li>
                    <div class="icondemo">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="{{URL::to('/ElementsController/brandIcons')}}">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="{{URL::to('/ElementsController/glyphicons')}}">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="{{URL::to('/ElementsController/ionicons')}}">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="{{URL::to('/ElementsController/materialDesign')}}">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="{{URL::to('/ElementsController/mfglabs')}}">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="{{URL::to('/ElementsController/openIconic')}}">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="{{URL::to('/ElementsController/themify')}}">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="{{URL::to('/ElementsController/weatherIcons')}}">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="{{URL::to('/ElementsController/octicons')}}">Read More</a>
                </div>
              </div>
            </div>
          </div>
