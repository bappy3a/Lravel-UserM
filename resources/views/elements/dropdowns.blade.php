...
<div class="page-header">
  <h1 class="page-title font_lato">Dropdowns </h1>
        ...
        <div class="panel-body container-fluid">
          <div class="row row-lg">
            <div class="col-lg-12">
              ...
              <div class="example-wrap">
                ...
                <p>Add dropdown menus to nearly anything with this simple plugin,
                  including the navbar, tabs, and pills. We provide a set color
                  of dropdown for your choice.</p>
                <div class="example example-dropdown">
                  <ul class="blocks-xs-100 blocks-sm-2 blocks-md-3 blocks-lg-4 blocks-dropdowns">
                    ...
                    <li>
                      <div class="dropdown">
                        <button type="button" class="btn btn-primary dropdown-toggle" id="exampleColorDropdown2" data-toggle="dropdown" aria-expanded="false">Primary
                          <span class="caret"></span>
                        </button>
                    ...
                    <li>
                      <div class="dropdown">
                        <button type="button" class="btn btn-success dropdown-toggle" id="exampleColorDropdown3" data-toggle="dropdown" aria-expanded="false">Success
                          <span class="caret"></span>
                        </button>
                    ...
                    <li>
                      <div class="dropdown">
                        <button type="button" class="btn btn-info dropdown-toggle" id="exampleColorDropdown4" data-toggle="dropdown" aria-expanded="false">Info
                          <span class="caret"></span>
                        </button>
                    ...
                    <li>
                      <div class="dropdown">
                        <button type="button" class="btn btn-warning dropdown-toggle" id="exampleColorDropdown5" data-toggle="dropdown" aria-expanded="false">Warning
                          <span class="caret"></span>
                        </button>
                    ...
                    <li>
                      <div class="dropdown">
                        <button type="button" class="btn btn-danger dropdown-toggle" id="exampleColorDropdown6" data-toggle="dropdown" aria-expanded="false">Danger
                          <span class="caret"></span>
                        </button>
                    ...
                    <li>
                      <div class="dropdown">
                        <button type="button" class="btn btn-dark dropdown-toggle" id="exampleColorDropdown7" data-toggle="dropdown" aria-expanded="false">Dark
                          <span class="caret"></span>
                        </button>
          ...
          <div class="row row-lg">
            <div class="col-lg-4 col-md-6">
              ...
              <div class="example-wrap">
                <h4 class="example-title">Basic Dropdown</h4>
                <p>Wrap the dropdown's trigger and the dropdown menu within .dropdown,
                  or another element that declares position: relative;. Then add
                  the menu's HTML.</p>
                <div class="example example-dropdown">
                  <div class="dropdown">
              ...
              <!-- End Example Basic Dropdown -->
            </div>
            <div class="col-lg-4 col-md-6">
              <!-- Example Alignment -->
              <div class="example-wrap">
                <h4 class="example-title">Alignment</h4>
                <p>By default, a dropdown menu is automatically positioned 100% from
                  the top and along the left side of its parent. Add <code>.dropdown-menu-right</code>                  to a <code>.dropdown-menu</code> to right align the dropdown
                  menu.
                  <br> To override it, use <code>.dropdown-menu-left</code>.</p>
                <div class="example example-dropdown">
                  <div class="dropdown">
              ...
              <!-- End Example Alignment -->
            </div>
            <div class="col-lg-4 col-md-6">
              <!-- Example Headers -->
              <div class="example-wrap">
                <h4 class="example-title">Headers</h4>
            ...
            <div class="col-lg-4 col-md-6">
              <!-- Example Divider -->
              <div class="example-wrap">
                <h4 class="example-title">Divider</h4>
            ...
            <div class="col-lg-4 col-md-6">
              <!-- Example Disabled -->
              <div class="example-wrap">
                <h4 class="example-title">Disabled Menu Items</h4>
                <p>Add <code>.disabled</code> to a <code>&lt;li&gt;</code> in the
                  dropdown to disable the link.</p>
                <div class="example example-dropdown">
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="exampleDisabledDropdown" role="menu">
                      <li role="presentation"><a href="javascript:void(0)" role="menuitem">Regular link</a></li>
                      <li class="disabled"><a href="javascript:void(0)">Disabled link</a></li>
                      <li role="presentation"><a href="javascript:void(0)" role="menuitem">Another link</a></li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6">
              <!-- Example Active -->
              <div class="example-wrap">
                <h4 class="example-title">Active Menu Items</h4>
                <p>Add <code>.active</code> to a <code>&lt;li&gt;</code> in the dropdown
                  to disable the link.</p>
                <div class="example example-dropdown">
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="exampleActiveDropdown" role="menu">
                      <li role="presentation"><a href="javascript:void(0)" role="menuitem">Regular link</a></li>
                      <li class="active" role="presentation"><a href="javascript:void(0)" role="menuitem">Active link</a></li>
                      <li role="presentation"><a href="javascript:void(0)" role="menuitem">Another link</a></li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <!-- Example Icons -->
              <div class="example-wrap">
                <h4 class="example-title">Icons Menu Items</h4>
                <div class="example example-dropdown">
                  <div class="dropdown">
                    <button type="button" class="btn btn-outline btn-default dropdown-toggle" id="exampleIconsDropdown" data-toggle="dropdown" aria-expanded="false">Icons Dropdown
                      <span class="caret"></span>
                    </button>
            ...
            <div class="col-lg-4 col-md-6">
              <!-- Example Badages -->
              <div class="example-wrap">
                <h4 class="example-title">Badages In Menu Items</h4>
                <div class="example example-dropdown">
                  <div class="dropdown">
                    <button type="button" class="btn btn-default dropdown-toggle" id="exampleBadagesDropdown" data-toggle="dropdown" aria-expanded="false">Default
                      <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu" aria-labelledby="exampleBadagesDropdown" role="menu">
                      <li role="presentation"><a href="javascript:void(0)" role="menuitem">Action<span class="badge badge-success pull-right">4</span></a></li>
                      <li role="presentation"><a href="javascript:void(0)" role="menuitem">Another action<span class="badge badge-info pull-right">2</span></a></li>
                      <li role="presentation"><a href="javascript:void(0)" role="menuitem">Something else here<span class="badge badge-warning pull-right">12</span></a></li>
                      <li class="divider" role="presentation"></li>
                      <li role="presentation"><a href="javascript:void(0)" role="menuitem">Separated link<span class="badge badge-danger pull-right">7</span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="example-wrap">
                ...
                <p>Animated dropdown item by adding <code>.animate</code> and adding
                  custom animate class to dropdown item.</p>
                <div class="example example-buttons">
                  <div class="btn-group">
                    <button type="button" class="btn btn-default dropdown-toggle" id="exampleAnimationDropdown1" data-toggle="dropdown" aria-expanded="false">Animation
                      <span class="caret"></span>
                    </button>
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="example-wrap padding-bottom-15">
                <h4 class="example-title">Split Button Dropdowns</h4>
                <p>Similarly, create split button dropdowns with the same markup changes,
                  only with a separate button.</p>
                <div class="example example-buttons">
                  <div class="btn-group">
            ...
            <div class="col-lg-4 col-md-6">
              <!-- Example Dropup -->
              <div class="example-wrap">
                <h4 class="example-title">Dropup Variation</h4>
                <p>Trigger dropdown menus above elements by adding <code>.dropup</code>                  to the parent.</p>
                <div class="example example-buttons">
                  <div class="btn-group dropup">
                    <button type="button" class="btn btn-default btn-outline">Dropup</button>
            ...
            <div class="col-lg-4 col-md-6">
              <!-- Example Bullet -->
              <div class="example-wrap">
                <h4 class="example-title">Bullet</h4>
                <p>To add bullet just add class <code>.bullet</code> to the dropdown
                  menu
                </p>
                <div class="example example-buttons">
            ...
            <div class="col-lg-4 col-md-6">
              <!-- Example Dropdown On Hover Plugin -->
              <div class="example-wrap">
                <h4 class="example-title">Dropdown On Hover Plugin
                  <small><a class="example-plugin-link" href="https://github.com/CWSpear/bootstrap-hover-dropdown" target="_blank">official website</a></small>
                </h4>
                <div class="example example-buttons">
                  <div class="btn-group">
              ...
              <!-- End Example Dropdown On Hover Plugin -->
            </div>
          </div>
          <div class="row row-lg">
            <div class="col-sm-12">
              <!-- Example Sub -->
              <div class="example-wrap">
                <h4 class="example-title">Sub Menus On Dropdowns</h4>
                <p>Add an extra level of dropdown menus, appearing on hover like those
                  of OS X, with some simple markup additions. Add <code>.dropdown-submenu</code>                  to any <code>li</code> in an existing dropdown menu for automatic
                  styling.
                </p>
                <div class="row row-lg">
                  <div class="col-lg-4 col-md-6">
                      ...
                      <div class="example example-dropdown">
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="exampleDefaultDropdownSubMenu" role="menu">
                            <li role="presentation"><a href="javascript:void(0)" role="menuitem" tabindex="-1">Action</a></li>
                            <li role="presentation"><a href="javascript:void(0)" role="menuitem" tabindex="-1">Another action</a></li>
                            <li role="presentation"><a href="javascript:void(0)" role="menuitem" tabindex="-1">Something else here</a></li>
                            <li class="divider" role="presentation"></li>
                            <li class="dropdown-submenu">
                              <a href="javascript:void(0)" role="button" tabindex="-1">More options</a>
                              <ul class="dropdown-menu" role="menu">
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem" tabindex="-1">Second level link</a></li>
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem" tabindex="-1">Second level link</a></li>
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem" tabindex="-1">Second level link</a></li>
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem" tabindex="-1">Second level link</a></li>
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem" tabindex="-1">Second level link</a></li>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="example-wrap">
                      <h4 class="example-title">Dropup</h4>
                      <div class="example example-dropdown">
                        <div class="dropup">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="exampleDropupSubMenu" role="menu">
                            ...
                            <li class="divider" role="presentation"></li>
                            <li class="dropdown-submenu">
                              <a href="javascript:void(0)" tabindex="-1">More options</a>
                              <ul class="dropdown-menu" role="menu">
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem" tabindex="-1">Second level link</a></li>
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem" tabindex="-1">Second level link</a></li>
                                <li role="presentation"><a href="javascript:void(0)" role="menuitem" tabindex="-1">Second level link</a></li>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="example-wrap">
                      <h4 class="example-title">Left Submenu</h4>
                      <div class="example example-dropdown">
                        <div class="dropdown">
