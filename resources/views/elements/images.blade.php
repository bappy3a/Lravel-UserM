            ...
            <div class="col-lg-6">
              ...
              <div class="example-wrap">
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <div class="example">
                      <img class="img-rounded" width="150" height="150" src="{{URL::to('/')}}/global/photos/placeholder.png"
                      alt="...">
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="example">
                      <img class="img-circle" width="150" height="150" src="{{URL::to('/')}}/global/photos/placeholder.png"
                      alt="...">
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="example">
                      <img width="150" height="150" src="{{URL::to('/')}}/global/photos/placeholder.png" alt="...">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <div class="example">
                      ...
                      src="{{URL::to('/')}}/global/photos/placeholder.png" alt="...">
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="example">
