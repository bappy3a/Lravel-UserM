              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  ...
                  data-main-class="mfp-img-mobile">
                    <img class="img-responsive" src="{{URL::to('/')}}/global/photos/placeholder.png" alt="..."
                    width="220" />
                  </a>
                  <a class="inline-block" href="{{URL::to('/')}}/global/photos/placeholder.png" data-plugin="magnificPopup">
                    <img class="img-responsive" src="{{URL::to('/')}}/global/photos/placeholder.png" alt="..."
            ...
            <div class="col-md-6">
              ...
              <div class="example-wrap">
                ...
                <div class="example" id="exampleGallery">
                  <a class="inline-block" href="{{URL::to('/')}}/global/photos/placeholder.png" title="view-4">
                    <img class="img-responsive" src="{{URL::to('/')}}/global/photos/placeholder.png" alt="..."
                    width="220" />
                  </a>
                  <a class="inline-block" href="{{URL::to('/')}}/global/photos/placeholder.png" title="view-5">
                    <img class="img-responsive" src="{{URL::to('/')}}/global/photos/placeholder.png" alt="..."
                    width="220" />
                  </a>
                  <a class="inline-block" href="{{URL::to('/')}}/global/photos/placeholder.png" title="view-6">
                    <img class="img-responsive" src="{{URL::to('/')}}/global/photos/placeholder.png" alt="..."
                    width="220" />
                  </a>
                </div>
            ...
            <div class="col-md-6">
              ...
              <div class="example-wrap">
                ...
                <div class="example" id="exampleZoomGallery">
                  <a class="inline-block" href="{{URL::to('/')}}/global/photos/placeholder.png" title="view-7"
                  data-source="{{URL::to('/')}}/global/photos/placeholder.png">
                    <img class="img-responsive" src="{{URL::to('/')}}/global/photos/placeholder.png" alt="..."
                    width="220" />
                  </a>
                  <a class="inline-block" href="{{URL::to('/')}}/global/photos/placeholder.png" title="view-8"
                  data-source="{{URL::to('/')}}/global/photos/placeholder.png">
                    <img class="img-responsive" src="{{URL::to('/')}}/global/photos/placeholder.png" alt="..."
                    width="220" />
                  </a>
                  <a class="inline-block" href="{{URL::to('/')}}/global/photos/placeholder.png" title="view-9"
                  data-source="{{URL::to('/')}}/global/photos/placeholder.png">
                    <img class="img-responsive" src="{{URL::to('/')}}/global/photos/placeholder.png" alt="..."
                    width="220" />
                  </a>
            ...
            <div class="col-md-6">
              ...
              <div class="example-wrap">
                ...
                <div class="example example-buttons">
                  <a class="popup-with-css-anim btn btn-primary btn-outline" href="{{URL::to('/')}}/global/photos/placeholder.png"
