                    ...
                    <div class="example-wrap">
                      ...
                      <div class="example">
                        <div class="example-well height-250 example-modal-top">
                          <img class="center" src="{{URL::to('/')}}/assets/examples/images/modal/modal-position.png"
                          alt="...">
                        </div>
                    ...
                    <div class="example-wrap">
                      ...
                      <div class="example">
                        <div class="example-well height-250 example-modal-sidebar">
                          <img class="center" src="{{URL::to('/')}}/assets/examples/images/modal/modal-position-sidebar.png"
                          alt="...">
                        </div>
          ...
          <div class="row row-lg">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <div class="example-well height-350">
                    <img class="center" src="{{URL::to('/')}}/assets/examples/images/modal/form-modal.png" alt="...">
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <div class="example-well height-350">
                    <img class="center" src="{{URL::to('/')}}/assets/examples/images/modal/multiple-modal.png"
                    alt="...">
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <div class="example-well height-350">
                    <img class="center" src="{{URL::to('/')}}/assets/examples/images/modal/size-modal.png" alt="...">
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <div class="example-well height-350">
                    <img class="center" src="{{URL::to('/')}}/assets/examples/images/modal/tab-modal.png" alt="...">
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <div class="example-well height-350">
                    <img class="center" src="{{URL::to('/')}}/assets/examples/images/modal/accordion-modal.png"
                    alt="...">
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <div class="example-well height-350">
                    <img class="center" src="{{URL::to('/')}}/assets/examples/images/modal/grid-modal.png" alt="...">
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="example-wrap margin-md-0">
                ...
                <div class="example">
                  <div class="example-well height-350">
                    <img class="center" src="{{URL::to('/')}}/assets/examples/images/modal/style-modal.png" alt="...">
                  </div>
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <div class="example-well height-350" style="background-color: #fff">
                    <img class="center width-full height-full" src="{{URL::to('/')}}/assets/examples/images/modal/fillin-modal.png"
                    alt="...">
                  </div>
