      ...
      <div class="panel">
        <div class="panel-heading">
          <h3 class="panel-title">Ladda Buttons
            <small><a class="example-plugin-link" href="http://msurguy.github.io/ladda-bootstrap/" target="_blank">official website</a></small>
          </h3>
        </div>
        <div class="panel-body container-fluid">
          <div class="row row-lg">
                ...
                <div class="example example-buttons">
                  ...
                  <div class="pull-left">
                    <button type="button" class="btn btn-primary ladda-button" data-style="slide-right" data-plugin="ladda">
                      <span class="ladda-label">Slide right<i class="icon wb-arrow-right margin-left-10" aria-hidden="true"></i></span>
                    <span class="ladda-spinner"></span></button>
                  </div>
                  <div class="pull-left">
