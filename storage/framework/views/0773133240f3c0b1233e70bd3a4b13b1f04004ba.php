...
<div class="page-header">
  <h1 class="page-title font_lato"><?php echo e(trans('app.user_details')); ?></h1>
	...
	<div class="col-md-9">
	  ...
	  <div class="panel">
		...
		<!------------------------start insert, update, delete message ---------------->
			...
			<a class="btn btn-icon btn-info btn-outline btn-round pull-right" href="<?php echo e(URL::to('edit')); ?>/<?php echo e($userdata->id); ?>" data-toggle="tooltip" data-original-title="<?php echo e(trans('app.edit_user')); ?>" ><i class="icon wb-pencil" aria-hidden="true"></i> </a>
				
		  <ul class="nav nav-tabs nav-tabs-line" data-plugin="nav-tabs" role="tablist">
			<li class="active" role="presentation"><a data-toggle="tab" href="#activities" aria-controls="activities" role="tab" aria-expanded="false"><?php echo e(trans('app.activities')); ?> </a></li>
			...
			<li class="dropdown" role="presentation" style="display: none;">
			  ...
			  <ul class="dropdown-menu" role="menu">
				<li role="presentation" style="display: none;"><a data-toggle="tab" href="#activities" aria-controls="activities" role="tab"><?php echo e(trans('app.activities')); ?> <span class="badge label-danger">5</span></a></li>
				...
				<li role="presentation"><a data-toggle="tab" href="#messages" aria-controls="messages" role="tab"><?php echo e(trans('app.message')); ?></a></li>
			  </ul>
			</li>
		  </ul>
